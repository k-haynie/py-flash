...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(580, 270))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(10, 199, 551, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.removeButton = QtWidgets.QPushButton(self.tab_3)
        self.removeButton.setGeometry(QtCore.QRect(480, 110, 75, 23))
        self.removeButton.setObjectName("removeButton")
        self.addButton = QtWidgets.QPushButton(self.tab_3)
        self.addButton.setGeometry(QtCore.QRect(480, 160, 75, 23))
        ...
        self.editButton.setGeometry(QtCore.QRect(480, 60, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Flashcards.exe"))
