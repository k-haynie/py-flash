...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 484, 191))
        ...
        self.deckDelBtn = QtWidgets.QPushButton(self.tab_3)
        self.deckDelBtn.setObjectName("deckDelBtn")
        self.horizontalLayout.addWidget(self.deckDelBtn)
