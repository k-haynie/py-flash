...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cardQuestion = QtWidgets.QPushButton(self.tab_2)
        self.cardQuestion.setMinimumSize(QtCore.QSize(100, 133))
        self.cardQuestion.setMaximumSize(QtCore.QSize(200, 267))
        self.cardQuestion.setObjectName("cardQuestion")
        self.gridLayout.addWidget(self.cardQuestion, 0, 0, 1, 1)
        self.cardAnswer = QtWidgets.QPlainTextEdit(self.tab_2)
        self.cardAnswer.setMinimumSize(QtCore.QSize(200, 267))
        self.cardAnswer.setMaximumSize(QtCore.QSize(200, 267))
        self.cardAnswer.setObjectName("cardAnswer")
        self.gridLayout.addWidget(self.cardAnswer, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cardQuestion.setText(_translate("MainWindow", "PushButton"))
