...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Animation = QtWidgets.QGraphicsView(self.tab_2)
        self.Animation.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 513, 476))
